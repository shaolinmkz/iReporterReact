 ...
 */
const About = () => {
  document.getElementById("site-title").innerHTML = "About";
  return (
    <div>
      <article className="actual-post" id="about">
        <div>
          ...
          <p>
            ...
            authorities and the general public. You can also report on things
          ...
          <p>
            ...
            uploads, geo-location of the occurence accompanied with a breif
            story or write-up.
          </p>
          <p>

...
/**
 * @description class component for the profile page
 * @return {undefined}
 */
class Profile extends Component {
	state = {
		...
		lastname: 'Nwabuzor',
		image: 'https://res.cloudinary.com/shaolinmkz/image/upload/v1553840626/ynkw4qvugqyfjoklt' + 'yrx.jpg',
		username: 'shaolinmkz',
	...
	loadProfileDetails = () => {
		return (
			<div className="profile-details-border">
				<img src={this.state.image} alt="avatar" className="large-avatar" id="user-profile-image" />
				<br />
			...
			<React.Fragment>
				<section className="profile" id="profile">
					<section className="inner-profile-border clearfix">
						<div className="profile-image-container clearfix">{this.loadProfileDetails()}</div>

						<div className="redflag-count-container clearfix">{this.loadRedflagCount()}</div>

						<div className="intervention-count-container clearfix">{this.loadInterventionCount()}</div>
					</section>
